...
using Microsoft.Xna.Framework.Input;
 ...
 public class Game1 : Game
 {
    ...
    {
        _arsenal.Add(new GunWeapon("AK-47", 0.08f, Color.Goldenrod, _pixel, 900f, 8, new Vector2(10, 4)));
    ...
    private void DrawHud()
    {
        ...
        _spriteBatch.DrawString(_arialFont, "X :" + _player.Position.X.ToString(), position, Color.White);
        position.Y += 20;
        _spriteBatch.DrawString(_arialFont, "Y :" + _player.Position.Y.ToString(), position, Color.White);
